  ...
  Future<Either<Failur, List<DisplayOrderEntity>>> getOrders(String uID) async {
    try {
      var data = await dataBaseServeces
          .getData(path: BackEndImpoint.getOrders, query: {
        'categoryField': 'uID',
        'categoryValue': uID,
      }) as List<Map<String, dynamic>>;
      List<DisplayOrderModel> products =
          data.map((e) => DisplayOrderModel.fromJson(e)).toList();
      List<DisplayOrderEntity> productEntit =
